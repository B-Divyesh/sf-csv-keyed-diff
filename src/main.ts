...
async function renderHome() {
  ...
  <main id="main">
    ...
    <figure class="hero-art"><div class="hero-visual"><picture><source media="(max-width: 600px)" srcset="/assets/reconciliation-lens-mobile.webp"><img src="/assets/reconciliation-lens.webp" width="960" height="640" alt="Two paper data sheets aligned behind a round inspection lens and a key-shaped pin, with three report slips below" fetchpriority="high" decoding="async"></picture><div class="diff-map" aria-hidden="true"><div class="diff-line changed"><span></span><i></i><span></span></div><div class="diff-line added"><span></span><i></i><span></span></div><div class="diff-line removed"><span></span><i></i><span></span></div></div></div><figcaption>The lens marks changed fields while the key aligns each record.</figcaption></figure></section>
