...
Generated with the factory image model (`factory-image`, Azure AI Foundry) on 2026-08-28. Generated output is original for this product. The selected source and prompt sidecar live in `assets/src/`; optimized WebP derivatives ship in `public/assets/`. The 1200 × 630 social image is a center crop of the selected source, produced locally on 2026-09-05. App icons are hand-authored SVG geometry and rasterized locally; they use the same key/lens motif.
